...
<iframe src="https://docs.google.com/spreadsheets/d/1X-3kWpGAACdkAJ8-AeqYiu5TS6tRzpfdgXBYyPooCPo/edit?gid=0#gid=0" width="640" height="800" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
...
source("../R/make_iframe_from_url.R")
```
...
res <- invisible(lapply(these_urls, return_iframe_chunk, data = ex01))
cat(unlist(res), sep = "\n")
```
