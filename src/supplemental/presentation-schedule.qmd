...
n_thu_31_remaining <- length(times) - n_tue_29_df

index_to_assign <- c(1:length(no_pref_remaining))[1:n_thu_31_remaining]

new_thu_31_df <- rbind(thu_31_df, 
                       no_pref_remaining[index_to_assign,])
new_thu_31_df$Time <- times[1:dim(new_thu_31_df)[1]]
