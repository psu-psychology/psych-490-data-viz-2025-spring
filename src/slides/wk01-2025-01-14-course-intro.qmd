...
- Visit [Exercise-00](exercises/ex01-figs-in-psych-sci.qmd)

```{r}
#| echo: false
#| fig-align: center
plot(qrcode::qr_code("https://psu-psychology.github.io/psych-490-data-viz-2025-spring/exercises/ex01-figs-in-psych-sci.html"))
```
