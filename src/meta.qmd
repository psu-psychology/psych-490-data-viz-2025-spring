...
Separate directories contain lecture slides (`slides/`), exercises (`exercises/`), class-specific R functions (`R/`), surveys (`surveys/`), and supplemental documents (`supplemental/`).
