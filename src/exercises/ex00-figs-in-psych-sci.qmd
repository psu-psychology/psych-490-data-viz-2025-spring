...
Specifically, enter your team identifier in the `identifier` field, the source in `source_type`, and the URL in the `url` field. If you have any comments to add, put those in the `comments` field.
